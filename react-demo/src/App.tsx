import { useEffect, useContext, useState, useCallback, useReducer, useMemo, useRef } from 'react';
import { BrowserRouter as Router, Switch, Route } from 'react-router-dom';
import ZoomVideo, { ConnectionState, ReconnectReason } from '@zoom/videosdk';
import VideoFooter from './feature/video/components/video-footer';
...
import Quixote from './feature/learnsight/pdf'
import './App.css';
...
function App(props: AppProps) {
  ...
  return (
    <div className="App">
      <div style = {{width:'100%', height:'20%'}}><h1>Header</h1></div>
      <div style={{ width: '20%', height : '20%', float:'left'}}>
        Section
      </div>
      <div style={{ overflow:'scroll',width: '40%', height : '500px', float:'left', border:'1px solid', margin:'2px'}}>
        <Quixote/>
      </div>
 ...
 {/* <VideoFooter className="video-operations" sharing= {false} shareRef={selfShareRef} /> */}
 </div>
